...
@njit
def getAcc_sph_shear_mpi(nbeg, nend, pos, v, rho, P, c, h, m, divV, curlV, alpha): # shear viscosity-corrected.
...
#===== getAcc_sph_mpi (with PI_ij as in Monaghan & Gingold 1983)
@njit
def getAcc_sph_shear_mpiX(nbeg, nend, pos, v, rho, P, c, h, m, divV, curlV, alpha, beta, eta): # shear viscosity-corrected.
...
@njit
def get_dU_shear_mpi(nbeg, nend, pos, v, rho, P, c, h, m, divV, curlV, alpha):
...
#===== get_dU_shear_mpi (with PI_ij as in Monaghan & Gingold 1983)
@njit
def get_dU_shear_mpiX(nbeg, nend, pos, v, rho, P, c, h, m, divV, curlV, alpha, beta, eta):
