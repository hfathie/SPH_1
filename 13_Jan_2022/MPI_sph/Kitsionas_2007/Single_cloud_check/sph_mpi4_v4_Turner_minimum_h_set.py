...
#----- P_polytrop_mpi
@njit
def P_polytrop_mpi(nbeg, nend, rho, T_cld, T_ps, T_0): # Turner et al - 1995
	...
	rho_0 = 7.0e-22 # g/cm^3 # Turner et al - 1995
	...
	for i in range(nbeg, nend):
		...
		if rhot <= rho_0:
			...
			P_res[i-nbeg] = rhot * ((c_0*c_0 - c_1*c_1) * (rhot/rho_0)**(-2./3.) + c_1)
...
UnitMass_in_g = 225.0 * M_sun       # !!!!!!!!!!!!!!!!!!!!!!!!! CHANGE !!!!!!!!!!!!!!!!!
R_0 = 1.94
...
with open('Data_Turner_Single_cloud.pkl', 'rb') as f:
	data = pickle.load(f)
