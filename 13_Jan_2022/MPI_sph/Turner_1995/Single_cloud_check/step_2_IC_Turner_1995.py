...
T_0 = 100. # K, see Table_1 in Anathpindika - 2009 - II
...
print('Central density (cm^-3) = ', rho_0/mH2)
#-----------------------------
...
vel = v_cld_1 * 0.0 # np.vstack((v_cld_1, v_cld_2))
...
dictx = {'r': res12, 'v': vel, 'h': h}

with open('Data_Turner_Single_cloud.pkl', 'wb') as f:
	pickle.dump(dictx, f)
#----------------------------
