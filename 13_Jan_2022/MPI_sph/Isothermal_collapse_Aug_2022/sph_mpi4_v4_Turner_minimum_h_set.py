...
#----- P_polytrop_mpi
@njit
def P_polytrop_mpi(nbeg, nend, rho, c_s):
...
@njit
def sound_speed_mpi(nbeg, nend, c_s):
...
c_s = 1.66e4  #(kB * T_0 / mH2)**0.5   # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

print(f'Speed of sound = {c_s}')
...
#--------- c ----------
c = 0.
local_c = sound_speed_mpi(nbeg, nend, c_s)
