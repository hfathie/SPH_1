...
one_pc_to_cm = 3.086e18
rho_c = 1.e-22 # assumption

R_0 = c_0 / (4.*np.pi*grav_const_in_cgs*rho_c)**0.5

print('R_0 (pc) = ', R_0/one_pc_to_cm)
...
MBE = c_0**3 / (4.*np.pi*grav_const_in_cgs**3*rho_c)**0.5 * mu_ksi_B**0.5

print('MBE (in M_sun) = ', MBE/M_sun)
#------------------------------
...
for j in range(nPart):
	...
	#r = Rand_r * ksi # This is wrong. Rand_r is a typo in Anathpindika paper, it must be R_0 !
	r = ksi * R_0 # This is correct.
...
plt.scatter(r_1_2[:, 0], r_1_2[:, 1], s = 0.1, color = 'k')
