...
#----- P_polytrop_mpi (Kitsionas et al - 2007)
@njit
def P_polytrop_mpi_XXX(nbeg, nend, rho, rho_0, rho_1, c_0, c_s):
...
#----- P_polytrop_mpi (Anathpindika - 2009)
@njit
...
#----- sound_speed_mpi
@njit
def sound_speed_mpi____XXX(nbeg, nend, rho, T_cld, T_ps, T_0):
