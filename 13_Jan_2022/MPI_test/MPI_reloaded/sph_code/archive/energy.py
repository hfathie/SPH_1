...
for j in range(0, len(filez), 100):   #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	ax[3].set_position([0.05, 0.05, 0.28, 0.40])
	ax[3].plot(t_all, U, color = 'blue', label='Thermal Energy')
	#ax[3].plot(t_allG, UG, color = 'blue', linestyle = '--')
	ax[3].plot(t_all, KE, color = 'lime', label = 'Kinetic Energy')
	#ax[3].plot(t_allG, KEG, color = 'lime', linestyle = '--')
	ax[3].plot(t_all, PE, color = 'red', label = 'Potential Energy')
	#ax[3].plot(t_allG, PEG, color = 'red', linestyle = '--')
	ax[3].plot(t_all, U+KE+PE, color = 'black', label = 'Total')
	#ax[3].plot(t_allG, UG+KEG+PEG, color = 'black', linestyle = '--')
	ax[3].text(0.01, 150, 't = ' + str(np.round(tt, 3)), fontsize = 16)
	#ax[3].axis(xmin = 0.005, xmax = 1.2)
	ax[3].axis(ymin = -2, ymax = 2)
	...
	if tt >= 30.0: kb = readchar.readkey()
